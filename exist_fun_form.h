#ifndef EXIST_FUN_FORM_H
#define EXIST_FUN_FORM_H
...
namespace Ui {
class Exist_fun_form;
}

class Exist_fun_form : public QWidget
{
    Q_OBJECT

public:
    explicit Exist_fun_form(QWidget *parent = nullptr);
    ~Exist_fun_form();
...
private:
    ...
    Ui::Exist_fun_form *ui;
};

#endif // EXIST_FUN_FORM_H
