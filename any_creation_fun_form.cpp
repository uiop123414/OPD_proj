...
#include "ui_any_creation_fun_form.h"

Any_creation_fun_form::Any_creation_fun_form(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Any_creation_fun_form)
{
    ui->setupUi(this);
    ...
    name_label->setText(QCoreApplication::translate("Form", "\320\236\320\277\320\265\321\200\320\260\321\206\320\270\321\217 \320\276\320\261\321\212\320\265\320\264\320\270\320\275\320\265\320\275\320\270\321\217 A", nullptr));
...
Any_creation_fun_form::~Any_creation_fun_form()
{
    delete ui;
}
